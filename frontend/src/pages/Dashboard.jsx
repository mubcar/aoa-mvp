...
import { MessageSquare, Filter, Settings, LogOut, Calendar } from "lucide-react";
...
export function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Setup gate — blurs everything until user books a call or admin links their account */}
      <SetupGate hasBusiness={!!business} />
          ...
          {filteredLeads.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-sm text-gray-400">
                Envie uma mensagem pelo WhatsApp para ver os leads aparecerem em tempo real
              </p>
            </div>
          ) : (
