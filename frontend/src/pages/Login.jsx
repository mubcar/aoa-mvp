    ...
    <div className="min-h-screen bg-black flex items-center justify-center px-6">
      <div className="w-full max-w-md">
        ...
        <div className="border border-white/10 bg-white/[0.02] rounded-2xl p-8">
          ...
          {resetSent && (
            <div className="mb-6 p-3 rounded-lg bg-emerald-500/10 border border-emerald-500/20 flex items-start gap-2">
              <CheckCircle className="w-4 h-4 text-emerald-500 mt-0.5 flex-shrink-0" />
              <p className="text-sm text-emerald-400">Link enviado! Verifique seu email.</p>
            </div>
          )}
            ...
            {!isForgot && (
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  {!isSignup && (
                    <button type="button" onClick={() => { setIsForgot(true); setError(""); setResetSent(false); }}
